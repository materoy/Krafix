...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < 4; i++)
        {
            ...
            lightingShader.setVec3("pointLights[" + index + "].ambient", glm::vec3(0.1f, 0.1f, 0.1f));
            lightingShader.setVec3("pointLights[" + index + "].diffuse", glm::vec3(0.8f, 0.8f, 0.8f));
            ...
            lightingShader.setFloat("pointLights[" + index + "].linear", 0.14f);
            lightingShader.setFloat("pointLights[" + index + "].quadratic", 0.07f);
            lightingShader.setVec3("pointLights[" + index + "].position", camera.Position);
        }
